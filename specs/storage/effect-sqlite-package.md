...
- `@mrcodetol/effect-drizzle-sqlite`
...
1. Add `@mrcodetol/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@mrcodetol/effect-drizzle-sqlite` as a dependency of `packages/opencode`.
