...
- `MrCodeTol` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `MrCodeTol` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `MrCodeTol` inside commands, URLs, package names, or code literals
