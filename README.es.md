...
MrCodeTol también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
...
MrCodeTol incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Para más información sobre cómo configurar MrCodeTol, [**ve a nuestra documentación**](https://opencode.ai/docs).

### Contribuir

Si te interesa contribuir a MrCodeTol, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en MrCodeTol

Si estás trabajando en un proyecto basado en MrCodeTol y usas "mrcodetol" como parte del nombre, por ejemplo, "mrcodetol-dashboard" u "mrcodetol-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de MrCodeTol y que no está afiliado con nosotros de ninguna manera.
