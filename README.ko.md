...
MrCodeTol 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [opencode.ai/download](https://opencode.ai/download) 를 이용하세요.
...
MrCodeTol 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
MrCodeTol 설정에 대한 자세한 내용은 [**문서**](https://opencode.ai/docs) 를 참고하세요.

### 기여하기

MrCodeTol 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### MrCodeTol 기반으로 만들기

MrCodeTol 와 관련된 프로젝트를 진행하면서 이름에 "mrcodetol"(예: "mrcodetol-dashboard" 또는 "mrcodetol-mobile") 를 포함한다면, README 에 해당 프로젝트가 MrCodeTol 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.
