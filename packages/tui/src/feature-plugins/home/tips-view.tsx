import type { TuiPluginApi } from "@mrcodetol/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent MrCodeTol from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode serve{/highlight} for headless API access to MrCodeTol",
  ...
  "Use {highlight}/connect{/highlight} with MrCodeTol Zen for curated, tested models",
