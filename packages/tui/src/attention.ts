...
import defaultSoundPath from "@mrcodetol/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@mrcodetol/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@mrcodetol/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@mrcodetol/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@mrcodetol/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@mrcodetol/ui/audio/yup-01.mp3" with { type: "file" }
