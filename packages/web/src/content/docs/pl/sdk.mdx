---
title: SDK
description: Typowany klient JS dla serwera MrCodeTol.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS MrCodeTol zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli MrCodeTol.
...
Jeśli masz już działającą instancję MrCodeTol, możesz utworzyć instancję klienta, aby się z nią połączyć:
...
```typescript
import type { Session, Message, Part } from "@mrcodetol/sdk"
```
