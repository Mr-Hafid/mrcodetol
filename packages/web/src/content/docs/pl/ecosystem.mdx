---
title: Ekosystem
description: Projekty i integracje zbudowane przy użyciu MrCodeTol.
---

Zbiór projektów społeczności zbudowanych na MrCodeTol.

:::note
Chcesz dodać swój projekt związany z MrCodeTol do tej listy? Prześlij PR.
:::
...
| Nazwa                                                                                              | Opis                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatyczne uruchamianie sesji MrCodeTol w izolowanych piaskownicach Daytona z synchronizacją git i podglądem na żywo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Śledź użycie MrCodeTol za pomocą Wakatime                                                                              |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Powiadomienia na pulpicie i alerty dźwiękowe dla sesji MrCodeTol                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatyczne nazywanie sesji Zellij oparte na AI w oparciu o kontekst MrCodeTol                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Pozwól agentom MrCodeTol na leniwe ładowanie promptów na żądanie z odkrywaniem umiejętności i wstrzykiwaniem           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Rozszerz komendy /commands MrCodeTol w potężny system orkiestracji ze szczegółową kontrolą przepływu                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Natywne powiadomienia systemowe dla MrCodeTol – wiedz, kiedy zadania się zakończą                                      |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bezproblemowe drzewa robocze git dla MrCodeTol                                                                         |
...
| Nazwa                                                                                      | Opis                                                                    |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord do sterowania sesjami MrCodeTol, zbudowany na SDK            |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Wtyczka Neovim dla promptów świadomych edytora, zbudowana na API        |
| [portal](https://github.com/hosenur/portal)                                                | Interfejs webowy mobile-first dla MrCodeTol przez Tailscale/VPN          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek MrCodeTol                                   |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim dla MrCodeTol - terminalowy agent kodujący AI            |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Dostawca Vercel AI SDK do używania MrCodeTol przez @mrcodetol/sdk      |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplikacja Web / Desktop i rozszerzenie VS Code dla MrCodeTol             |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Wtyczka Obsidian osadzająca MrCodeTol w interfejsie Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Otwartoźródłowa alternatywa dla Claude Cowork, napędzana przez MrCodeTol |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Menedżer rozszerzeń MrCodeTol z przenośnymi, izolowanymi profilami.      |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplikacja kliencka Desktop, Web, Mobile i Remote dla MrCodeTol           |
