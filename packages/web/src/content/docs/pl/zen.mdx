---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez MrCodeTol.
---
...
MrCodeTol Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół MrCodeTol.

Zen działa jak każdy inny dostawca w MrCodeTol. Logujesz się do MrCodeTol Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z MrCodeTol.
:::
...
MrCodeTol Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

MrCodeTol Zen działa jak każdy inny dostawca w MrCodeTol.

1. Logujesz się do **<a href={console}>MrCodeTol Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz MrCodeTol Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji MrCodeTol używa formatu
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. MrCodeTol używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w MrCodeTol przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy MrCodeTol Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w MrCodeTol także dowolnego innego dostawcy.
