---
title: Serwery LSP
description: MrCodeTol integruje się z serwerami LSP.
---

MrCodeTol może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

MrCodeTol posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i MrCodeTol otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji MrCodeTol.
