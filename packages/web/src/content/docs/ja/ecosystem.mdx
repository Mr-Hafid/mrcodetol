---
title: エコシステム
description: MrCodeTol で構築されたプロジェクトと統合。
---

MrCodeTol に基づいて構築されたコミュニティプロジェクトのコレクション。

:::note
MrCodeTol 関連プロジェクトをこのリストに追加したいですか? PR を送信してください。
:::
...
| 名前                                                                                               | 説明                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync とライブプレビューを使用して、隔離された Daytona サンドボックスで MrCodeTol セッションを自動的に実行します。 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | wakatime で MrCodeTol の使用状況を追跡する                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | MrCodeTol セッションのデスクトップ通知とサウンドアラート                                                              |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 許可、完了、エラーイベントのデスクトップ通知とサウンドアラート                                                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | MrCodeTol コンテキストに基づいた AI による自動 Zellij セッション命名                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | MrCodeTol エージェントがスキルの検出と挿入を使用してオンデマンドでプロンプトを遅延ロードできるようにする              |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | MrCodeTol/コマンドをきめ細かいフロー制御を備えた強力なオーケストレーションシステムに拡張                              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | MrCodeTol のネイティブ OS 通知 – タスクがいつ完了したかを知る                                                         |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | バンドルされたマルチエージェントオーケストレーションハーネス – 16 コンポーネント、1 回のインストール                 |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | MrCodeTol 用のゼロフリクション Git ワークツリー                                                                       |
...
| 名前                                                                                       | 説明                                                                             |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 上に構築された MrCodeTol セッションを制御する Discord ボット                  |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API に基づいて構築された、エディター対応プロンプト用の Neovim プラグイン         |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 上の MrCodeTol 向けモバイルファースト Web UI                        |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | MrCodeTol プラグインを構築するためのテンプレート                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim MrCodeTol用フロントエンド - ターミナルベースの AI コーディングエージェント |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @mrcodetol/sdk 経由で MrCodeTol を使用するための Vercel AI SDK プロバイダー     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | MrCodeTol 用の Web/デスクトップアプリと VS Code 拡張機能                          |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian の UI に MrCodeTol を埋め込む Obsidian プラグイン                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | MrCodeTol を利用した、Claude Cowork に代わるオープンソース                        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 移植可能な独立したプロファイルを備えた MrCodeTol 拡張機能マネージャー。           |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | MrCodeTol 用のデスクトップ、Web、モバイル、およびリモートクライアントアプリ       |
