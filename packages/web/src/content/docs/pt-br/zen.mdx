---
title: Zen
description: Lista selecionada de modelos fornecidos pelo MrCodeTol.
---
...
O MrCodeTol Zen é uma lista de modelos testados e verificados fornecidos pela equipe do MrCodeTol.

O Zen funciona como qualquer outro provedor no MrCodeTol. Você faz login no MrCodeTol Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o MrCodeTol.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o MrCodeTol.
:::
...
O MrCodeTol Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O MrCodeTol Zen funciona como qualquer outro provedor no MrCodeTol.

1. Você faz login no **<a href={console}>MrCodeTol Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona MrCodeTol Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do MrCodeTol usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `opencode/gpt-5.5` na sua configuração.
...
Você pode notar [modelos de baixo custo](/docs/config/#models), como Haiku, Nano ou Flash, no seu histórico de uso. O MrCodeTol usa esses modelos para gerar títulos de sessões.
...
- DeepSeek V4 Flash Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Hy3 Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Laguna S 2.1 Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3.5 Lightning Free está disponível no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no MrCodeTol por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o MrCodeTol também.
