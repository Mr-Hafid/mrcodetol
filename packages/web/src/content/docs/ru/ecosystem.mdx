---
title: Экосистема
description: Проекты и интеграции, созданные с помощью MrCodeTol.
---

Коллекция проектов сообщества, построенных на MrCodeTol.

:::note
Хотите добавить свой проект, связанный с MrCodeTol, в этот список? Разместите PR.
:::
...
| Имя                                                                                                | Описание                                                                                                                                         |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Автоматически запускайте сеансы MrCodeTol в изолированных песочницах Daytona с синхронизацией git и предварительным просмотром в реальном времени |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Отслеживайте использование MrCodeTol с помощью Wakatime                                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Уведомления на рабочем столе и звуковые оповещения для сеансов MrCodeTol                                                                          |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Автоматическое именование сеансов Zellij на основе искусственного интеллекта на основе контекста MrCodeTol                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Разрешить агентам MrCodeTol отложенную загрузку подсказок по требованию с обнаружением и внедрением навыков                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Встроенные уведомления ОС для MrCodeTol – узнайте, когда задачи завершены                                                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Рабочие деревья git с нулевым трением для MrCodeTol                                                                                               |
...
| Имя                                                                                        | Описание                                                                                      |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-бот для управления сеансами MrCodeTol, созданный на базе SDK                           |
...
| [portal](https://github.com/hosenur/portal)                                                | Мобильный веб-интерфейс для MrCodeTol через Tailscale/VPN                                      |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Шаблон для создания плагинов MrCodeTol                                                         |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Интерфейс Neovim для MrCodeTol - агент кодирования искусственного интеллекта на базе терминала |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Поставщик Vercel AI SDK для использования MrCodeTol через @mrcodetol/sdk                     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Веб-приложение или настольное приложение и расширение VS Code для MrCodeTol                    |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Плагин Obsidian, встраивающий MrCodeTol в пользовательский интерфейс Obsidian                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Альтернатива Claude Cowork с открытым исходным кодом на базе MrCodeTol                         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Менеджер расширений MrCodeTol с переносимыми изолированными профилями                          |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Настольное, веб-, мобильное и удаленное клиентское приложение для MrCodeTol                    |
