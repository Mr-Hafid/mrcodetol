---
title: TUI
description: การใช้อินเทอร์เฟซผู้ใช้ terminal MrCodeTol
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MrCodeTol มีอินเทอร์เฟซ terminal แบบโต้ตอบหรือ TUI สำหรับการทำงานในโครงการของคุณด้วย LLM

การรัน MrCodeTol จะเริ่มต้น TUI สำหรับไดเร็กทอรีปัจจุบัน
...
เมื่อใช้ MrCodeTol TUI คุณสามารถพิมพ์ `/` ตามด้วยชื่อคำสั่งเพื่อดำเนินการอย่างรวดเร็ว ตัวอย่างเช่น:
...
เพิ่มผู้ให้บริการให้กับ MrCodeTol ให้คุณเลือกจากผู้ให้บริการที่มีอยู่และเพิ่มคีย์ API
...
ออกจาก MrCodeTol _นามแฝง_: `/quit`, `/q`
...
- `leader_timeout` - ควบคุมระยะเวลาที่ MrCodeTol จะรอหลังจากกด leader key ค่าเริ่มต้นคือ `2000`
