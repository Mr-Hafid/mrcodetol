...
description: MrCodeTol, LSP sunucularınızla bütünleşir.
---

MrCodeTol, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

MrCodeTol, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
