...
MrCodeTol Zen, MrCodeTol ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, MrCodeTol'daki diğer sağlayıcılar gibi çalışır. MrCodeTol Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve MrCodeTol kullanmak için buna ihtiyacınız yoktur.
...
:::tip
MrCodeTol ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
MrCodeTol Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

MrCodeTol Zen, MrCodeTol'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>MrCodeTol Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, MrCodeTol Zen'i seçin ve API anahtarınızı yapıştırın.
...
MrCodeTol yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. MrCodeTol, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Hy3 Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3.5 Lightning Free, sınırlı bir süre için MrCodeTol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için MrCodeTol'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
MrCodeTol Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca MrCodeTol ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
