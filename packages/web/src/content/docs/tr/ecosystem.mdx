...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @mrcodetol/sdk aracılığıyla OpenCode kullanmak için Vercel AI SDK sağlayıcısı |
