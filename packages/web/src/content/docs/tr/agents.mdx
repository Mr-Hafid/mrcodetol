...
MrCodeTol, **General**, **Explore** ve **Scout** olmak üzere üç yerleşik alt agent ile birlikte gelir. Buna aşağıda bakacağız.

---

## Yerleşik

MrCodeTol iki yerleşik birincil agent ve üç yerleşik alt agent ile birlikte gelir.
...
opencode yapılandırmanızdaki model kimliği `provider/model-id` biçimini kullanır. Örneğin, [MrCodeTol Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `opencode/gpt-5.1-codex` kullanırsınız.
