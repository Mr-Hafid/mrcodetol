---
title: Zen
description: Utvalgt liste over modeller levert av MrCodeTol.
---
...
MrCodeTol Zen er en liste over testede og verifiserte modeller levert av MrCodeTol-teamet.

Zen fungerer som enhver annen leverandør i MrCodeTol. Du logger inn på MrCodeTol Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med MrCodeTol.
:::
...
MrCodeTol Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

MrCodeTol Zen fungerer som enhver annen leverandør i MrCodeTol.

1. Du logger inn på **<a href={console}>MrCodeTol Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger MrCodeTol Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i MrCodeTol-konfigurasjonen din
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. MrCodeTol bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på MrCodeTol i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet MrCodeTol Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med MrCodeTol også.
