---
title: Økosystem
description: Prosjekter og integrasjoner bygget med MrCodeTol.
---

En samling fellesskapsprosjekter bygget på MrCodeTol.

:::note
Vil du legge til ditt MrCodeTol-relaterte prosjekt til denne listen? Send inn en PR.
:::
...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør MrCodeTol-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor MrCodeTol-bruk med Wakatime                                                                               |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for MrCodeTol-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på MrCodeTol-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat MrCodeTol-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid MrCodeTol /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for MrCodeTol – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for MrCodeTol                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere MrCodeTol-økter, bygget på SDK         |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin for editor-tilpassede meldinger, bygget på API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for MrCodeTol over Tailscale/VPN                 |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge MrCodeTol-plugins                                    |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-grensesnitt for MrCodeTol - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av MrCodeTol via @mrcodetol/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for MrCodeTol               |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn MrCodeTol i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av MrCodeTol  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | MrCodeTol utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for MrCodeTol              |
