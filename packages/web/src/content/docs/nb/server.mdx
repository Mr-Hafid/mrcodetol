---
title: Tjener
description: Samhandle med MrCodeTol-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en MrCodeTol-klient kan bruke.
...
:::tip
Bruk MrCodeTol-serveren til å samhandle med MrCodeTol programmatisk.
:::

Denne arkitekturen lar MrCodeTol støtte flere klienter og lar deg samhandle med MrCodeTol programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
MrCodeTol TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av MrCodeTol [IDE](/docs/ide) plugins.
