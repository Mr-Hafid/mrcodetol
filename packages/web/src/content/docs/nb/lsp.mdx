...
MrCodeTol kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

MrCodeTol kommer med flere innebygde LSP-servere for populære språk:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i MrCodeTol-konfigurasjonen.
