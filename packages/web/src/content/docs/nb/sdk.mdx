---
title: SDK
description: Typesikker JS-klient for MrCodeTol-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

MrCodeTol JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere MrCodeTol programmatisk.
...
Opprett en forekomst av MrCodeTol:
...
Hvis du allerede har en kjørende forekomst av MrCodeTol, kan du opprette en klientforekomst for å koble til den:
