---
title: Web
description: Bruke MrCodeTol i nettleseren din.
---

MrCodeTol kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![MrCodeTol Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk MrCodeTol i standard nettleser.
...
Som standard velger MrCodeTol en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun localhost). Slik gjør du MrCodeTol tilgjengelig på nettverket ditt:
...
Når den er startet, gir nettgrensesnittet tilgang til dine MrCodeTol-økter.
