---
title: LSP Servers
description: MrCodeTol integrates with your LSP servers.
---

MrCodeTol can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

MrCodeTol comes with several built-in LSP servers for popular languages:
