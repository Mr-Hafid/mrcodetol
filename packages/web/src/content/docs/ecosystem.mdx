---
title: Ecosystem
description: Projects and integrations built with MrCodeTol.
---

A collection of community projects built on MrCodeTol.

:::note
Want to add your MrCodeTol related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytona/integrations/tree/main/packages/opencode-plugin)     | Automatically run MrCodeTol sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track MrCodeTol usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for MrCodeTol sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on MrCodeTol context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow MrCodeTol agents to lazy load prompts on demand with skill discovery and injection            |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for MrCodeTol – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for MrCodeTol                                                           |
...
| [opencode-goal-plugin](https://github.com/willytop8/MrCodeTol-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control MrCodeTol sessions, built on the SDK       |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building MrCodeTol plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for opencode - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using MrCodeTol via @mrcodetol/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for MrCodeTol             |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds MrCodeTol in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by MrCodeTol |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | MrCodeTol extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for MrCodeTol          |
