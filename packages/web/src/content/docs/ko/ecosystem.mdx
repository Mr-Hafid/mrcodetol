---
title: 생태계
description: MrCodeTol로 구축된 프로젝트와 통합.
---

MrCodeTol를 기반으로 만들어진 커뮤니티 프로젝트 모음입니다.

:::note
이 목록에 MrCodeTol 관련 프로젝트를 추가하고 싶다면 PR을 제출하세요.
:::
...
| 이름                                                                                               | 설명                                                                                            |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync와 live preview를 지원하는 격리된 Daytona sandbox에서 MrCodeTol 세션을 자동 실행합니다.  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime으로 MrCodeTol 사용량을 추적합니다.                                                      |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | MrCodeTol 세션에 데스크톱 알림과 사운드 알림을 제공합니다.                                       |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | permission, 완료, 오류 이벤트에 대한 데스크톱 알림과 사운드 알림을 제공합니다.                  |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | MrCodeTol 맥락을 기반으로 Zellij session 이름을 AI로 자동 지정합니다.                            |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | skill 탐색과 주입을 통해 MrCodeTol agent가 필요 시 prompt를 lazy load하도록 합니다.              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | MrCodeTol 작업 완료 시점을 native OS 알림으로 알려줍니다.                                        |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | MrCodeTol용 git worktree를 손쉽게 사용할 수 있도록 돕습니다.                                     |
...
| 이름                                                                                       | 설명                                                                   |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 기반으로 MrCodeTol 세션을 제어하는 Discord bot입니다.               |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API 기반 editor-aware prompt를 제공하는 Neovim plugin입니다.           |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 환경에서 MrCodeTol를 쓰기 위한 mobile-first 웹 UI입니다.  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | MrCodeTol plugin 개발을 위한 템플릿입니다.                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | terminal 기반 AI 코딩 agent인 opencode용 Neovim frontend입니다.        |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | `@mrcodetol/sdk`로 MrCodeTol를 사용하는 Vercel AI SDK provider입니다. |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | MrCodeTol용 Web/Desktop App 및 VS Code Extension입니다.                 |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian UI에 MrCodeTol를 내장하는 Obsidian plugin입니다.               |
| [OpenWork](https://github.com/different-ai/openwork)                                       | MrCodeTol 기반의 Claude Cowork 대체 오픈소스 프로젝트입니다.            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 휴대형 격리 프로필을 지원하는 MrCodeTol extension manager입니다.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | MrCodeTol용 Desktop/Web/Mobile/Remote client app입니다.                 |
