---
title: LSP serveri
description: MrCodeTol se integriše sa vašim LSP serverima.
---

MrCodeTol se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

MrCodeTol dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
