...
Agent skills omogucavaju MrCodeTol da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
MrCodeTol pretrazuje ove lokacije:
...
Za projektne lokalne putanje, MrCodeTol ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
MrCodeTol navodi dostupne skills u opisu `skill` alata.
