---
title: Dodaci
description: Napišite vlastite dodatke za proširenje MrCodeTol.
---

Dodaci vam omogućavaju da proširite MrCodeTol spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja MrCodeTol.
...
MrCodeTol pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje MrCodeTol.
