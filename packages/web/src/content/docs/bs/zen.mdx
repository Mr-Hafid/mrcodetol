---
title: Zen
description: Kurirana lista modela koje nudi MrCodeTol.
---
...
MrCodeTol Zen je lista testiranih i provjerenih modela koje pruža MrCodeTol tim.

Zen radi kao i svaki drugi provajder u MrCodeTol. Prijavite se na MrCodeTol Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili MrCodeTol.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s MrCodeTol.
:::
...
MrCodeTol Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

MrCodeTol Zen radi kao i svaki drugi provajder u MrCodeTol.

1. Prijavite se na **<a href={console}>MrCodeTol Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite MrCodeTol Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj MrCodeTol konfiguraciji koristi format
...
U historiji korištenja možete primijetiti [jeftinije modele](/docs/config/#models), kao što su Haiku, Nano ili Flash. MrCodeTol koristi ove modele za generisanje naslova sesija.
...
- DeepSeek V4 Flash Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Hy3 Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Laguna S 2.1 Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3.5 Lightning Free je dostupan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na MrCodeTol ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
MrCodeTol Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u MrCodeTol.
