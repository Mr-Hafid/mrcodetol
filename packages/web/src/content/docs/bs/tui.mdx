---
title: TUI
description: Korištenje korisničkog interfejsa MrCodeTol terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MrCodeTol pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MrCodeTol pokreće TUI za trenutni direktorij.
...
Kada koristite MrCodeTol TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MrCodeTol. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MrCodeTol. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo MrCodeTol čeka nakon leader key. Podrazumijevano je `2000`.
