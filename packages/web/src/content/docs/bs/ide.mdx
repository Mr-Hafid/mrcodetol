---
title: IDE
description: Ekstenzija MrCodeTol za VS Code, Cursor i druge IDE
---

MrCodeTol se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `opencode` u terminalu da započnete.

---

## Korištenje

- **Brzo pokretanje**: Koristite `Cmd+Esc` (Mac) ili `Ctrl+Esc` (Windows/Linux) da otvorite MrCodeTol u prikazu podijeljenog terminala ili fokusirajte postojeću terminalsku sesiju ako je već pokrenuta.
- **Nova sesija**: Koristite `Cmd+Shift+Esc` (Mac) ili `Ctrl+Shift+Esc` (Windows/Linux) da započnete novu MrCodeTol terminalsku sesiju, čak i ako je ona već otvorena. Takođe možete kliknuti na dugme MrCodeTol u korisničkom sučelju.
- **Svijest o kontekstu**: Automatski dijelite svoj trenutni odabir ili karticu s MrCodeTol.
...
Da biste instalirali MrCodeTol na VS Code i popularne viljuške kao što su Cursor, Windsurf, VSCodium:
...
Potražite **MrCodeTol** na Extension Marketplaceu i kliknite na **Instaliraj**.
