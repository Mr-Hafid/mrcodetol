...
U MrCodeTol mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, MrCodeTol koristi nasu `opencode` temu.
...
MrCodeTol dolazi sa vise ugradenih tema.
...
- Zele da MrCodeTol odgovara izgledu njihovog terminala
...
MrCodeTol podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
