---
title: Zen
description: Lista curata di modelli fornita da MrCodeTol.
---
...
MrCodeTol Zen è un elenco di modelli testati e verificati forniti dal team di MrCodeTol.

Zen funziona come qualsiasi altro provider in MrCodeTol. Accedi a MrCodeTol Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con MrCodeTol.
:::
...
MrCodeTol Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

MrCodeTol Zen funziona come qualsiasi altro provider in MrCodeTol.

1. Accedi a **<a href={console}>MrCodeTol Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona MrCodeTol Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di MrCodeTol
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. MrCodeTol usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Laguna S 2.1 Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su MrCodeTol per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato MrCodeTol Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con MrCodeTol.
