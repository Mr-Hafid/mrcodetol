...
Le skill degli agenti permettono a MrCodeTol di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
MrCodeTol cerca in queste posizioni:
...
Per i percorsi locali al progetto, MrCodeTol risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
MrCodeTol elenca le skill disponibili nella descrizione dello strumento `skill`.
