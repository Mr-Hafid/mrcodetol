---
title: Plugin
description: Scrivi plugin per estendere MrCodeTol.
---

I plugin ti permettono di estendere MrCodeTol agganciandoti a vari eventi e personalizzando il comportamento. Puoi creare plugin per aggiungere nuove funzionalità, integrare servizi esterni o modificare il comportamento predefinito di MrCodeTol.
...
MrCodeTol esegue `bun install` all'avvio per installarle. I tuoi plugin e strumenti potranno poi importarle.
...
:::note
Se usi l'app desktop di MrCodeTol, può inviare automaticamente notifiche di sistema quando una risposta è pronta o quando una sessione va in errore.
:::
