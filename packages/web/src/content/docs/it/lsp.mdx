---
title: Server LSP
description: MrCodeTol si integra con i tuoi server LSP.
---

MrCodeTol può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

MrCodeTol include diversi server LSP integrati per linguaggi popolari:
