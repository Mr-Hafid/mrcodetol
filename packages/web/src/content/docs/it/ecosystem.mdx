---
title: Ecosistema
description: Progetti e integrazioni costruiti con MrCodeTol.
---

Una raccolta di progetti della comunità costruiti su MrCodeTol.

:::note
Vuoi aggiungere il tuo progetto legato a MrCodeTol a questa lista? Apri una PR.
:::
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni MrCodeTol in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di MrCodeTol con Wakatime                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni MrCodeTol                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto MrCodeTol                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti MrCodeTol di caricare prompt al bisogno con discovery e injection di skill    |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per MrCodeTol: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per MrCodeTol                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni MrCodeTol, costruito sull'SDK    |
...
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per MrCodeTol su Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin MrCodeTol                               |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per opencode: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare MrCodeTol tramite @mrcodetol/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per MrCodeTol                   |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra MrCodeTol nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da MrCodeTol      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni MrCodeTol con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per MrCodeTol                |
