...
You can add custom commands through the MrCodeTol config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your MrCodeTol [config](/docs/config):
