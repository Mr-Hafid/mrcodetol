...
تتيح مهارات الوكيل لـ MrCodeTol اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج MrCodeTol صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض MrCodeTol المهارات المتاحة في وصف أداة `skill`.
