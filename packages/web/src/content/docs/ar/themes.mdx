...
مع MrCodeTol يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم MrCodeTol سمتنا `opencode`.
...
يأتي MrCodeTol مع عدة سمات مدمجة.
...
- يريدون أن يطابق MrCodeTol مظهر terminal لديهم
...
يدعم MrCodeTol نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
