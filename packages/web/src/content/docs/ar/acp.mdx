---
title: دعم ACP
description: استخدم MrCodeTol في أي محرر متوافق مع ACP.
---

يدعم MrCodeTol بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام MrCodeTol عبر ACP، اضبط محررك ليشغّل الأمر `opencode acp`.

يشغّل هذا الأمر MrCodeTol كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'MrCodeTol' من محدد الوكلاء في AI Chat.
...
لاستخدام MrCodeTol كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام MrCodeTol كوكيل ACP للدردشة.
...
يعمل MrCodeTol عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات MrCodeTol
