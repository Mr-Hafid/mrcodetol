---
title: TUI
description: استخدام واجهة المستخدم TUI في MrCodeTol.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر MrCodeTol واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل MrCodeTol إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة MrCodeTol في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى MrCodeTol. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من MrCodeTol. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار MrCodeTol بعد الضغط على leader key. القيمة الافتراضية `2000`.
