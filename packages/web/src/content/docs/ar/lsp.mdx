---
title: خوادم LSP
description: يتكامل MrCodeTol مع خوادم LSP لديك.
---

يمكن أن يتكامل MrCodeTol مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي MrCodeTol مع عدة خوادم LSP مدمجة للغات الشائعة:
