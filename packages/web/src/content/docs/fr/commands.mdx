...
Vous pouvez ajouter des commandes personnalisées via la configuration MrCodeTol ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre MrCodeTol [config](/docs/config) :
