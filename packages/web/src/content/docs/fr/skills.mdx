...
Les compétences d'agent permettent à MrCodeTol de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
MrCodeTol recherche ces emplacements :
...
Pour les chemins locaux du projet, MrCodeTol remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
MrCodeTol répertorie les compétences disponibles dans la description de l'outil `skill`.
