---
title: Écosystème
description: Projets et intégrations construits avec MrCodeTol.
---

Une collection de projets communautaires construits sur MrCodeTol.

:::note
Vous souhaitez ajouter votre projet lié à MrCodeTol à cette liste ? Soumettez une PR.
:::
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions MrCodeTol dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'MrCodeTol avec Wakatime                                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions MrCodeTol                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte MrCodeTol                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents MrCodeTol le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour MrCodeTol – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour MrCodeTol                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions MrCodeTol, construit sur le SDK      |
...
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour MrCodeTol via Tailscale/VPN                  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins MrCodeTol                                      |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser MrCodeTol via @mrcodetol/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour MrCodeTol                 |
| [MrCodeTol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre MrCodeTol dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par MrCodeTol         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions MrCodeTol avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour MrCodeTol            |
