...
Con MrCodeTol puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, MrCodeTol usa nuestro propio tema `opencode`.
...
MrCodeTol viene con varios temas integrados.
...
- Quiere que MrCodeTol coincida con la apariencia de su terminal
...
MrCodeTol admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
