...
description: MrCodeTol se integra con sus servidores LSP.
---

MrCodeTol puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

MrCodeTol viene con varios servidores LSP integrados para idiomas populares:
