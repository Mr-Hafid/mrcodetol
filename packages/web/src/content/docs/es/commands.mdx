...
Puede agregar comandos personalizados a través de la configuración MrCodeTol o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MrCodeTol [config](/docs/config):
