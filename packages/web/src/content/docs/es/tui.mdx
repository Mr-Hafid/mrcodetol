---
title: TUI
description: Usando la interfaz de usuario del terminal MrCodeTol.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MrCodeTol proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar MrCodeTol se inicia TUI para el directorio actual.
...
Cuando utilice MrCodeTol TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a MrCodeTol. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de MrCodeTol. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera MrCodeTol después de la leader key. El valor predeterminado es `2000`.
