...
Las habilidades del agente permiten a MrCodeTol descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
MrCodeTol busca estas ubicaciones:
...
Para las rutas locales del proyecto, MrCodeTol sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
MrCodeTol enumera las habilidades disponibles en la descripción de la herramienta `skill`.
