---
title: Compartir
description: Comparte tus conversaciones MrCodeTol.
---

La función para compartir de MrCodeTol te permite crear enlaces públicos a tus conversaciones de MrCodeTol, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, MrCodeTol:
...
MrCodeTol admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, MrCodeTol usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
