---
title: Zen
description: Curated list of models provided by MrCodeTol.
---
...
MrCodeTol Zen is a list of tested and verified models provided by the MrCodeTol team.

Zen works like any other provider in MrCodeTol. You login to MrCodeTol Zen and get
...
:::tip
We tested a select group of models and providers that work well with MrCodeTol.
:::
...
MrCodeTol Zen is an AI gateway that gives you access to these models.

---

## How it works

MrCodeTol Zen works like any other provider in MrCodeTol.

1. You sign in to **<a href={console}>MrCodeTol Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select MrCodeTol Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your MrCodeTol config
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. MrCodeTol uses these models to generate session titles.
...
- DeepSeek V4 Flash Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- Hy3 Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- Laguna S 2.1 Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3.5 Lightning Free is available on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on MrCodeTol for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with MrCodeTol as well.
