...
With MrCodeTol you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, MrCodeTol uses our own `opencode` theme.
...
MrCodeTol comes with several built-in themes.
...
- Want MrCodeTol to match their terminal's appearance
...
MrCodeTol supports a flexible JSON-based theme system that allows users to create and customize themes easily.
