...
description: Erstellen Sie Tools, die der LLM in MrCodeTol aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von MrCodeTol wie `read`, `write` und `bash`.
