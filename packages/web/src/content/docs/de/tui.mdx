---
title: TUI
description: Arbeite mit MrCodeTol in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MrCodeTol bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet MrCodeTol die TUI im aktuellen Verzeichnis.
...
In der MrCodeTol-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu MrCodeTol hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet MrCodeTol. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange MrCodeTol nach der leader key wartet. Standard ist `2000`.
