---
title: LSP Server
description: MrCodeTol lässt sich in Ihren LSP-Server integrieren.
---

MrCodeTol kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

MrCodeTol verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und MrCodeTol eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer MrCodeTol-Konfiguration aktivieren und anpassen.
