...
Agent Skills erlauben MrCodeTol, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
MrCodeTol sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft MrCodeTol vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
MrCodeTol listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
