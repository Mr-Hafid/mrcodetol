---
title: Zen
description: Kuratierte Modellliste direkt von MrCodeTol.
---
...
MrCodeTol Zen ist eine Liste von getesteten und verifizierten Modellen, die vom MrCodeTol-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in MrCodeTol. Du meldest dich bei MrCodeTol Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um MrCodeTol zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit MrCodeTol funktionieren.
:::
...
MrCodeTol Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

MrCodeTol Zen funktioniert wie jeder andere Provider in MrCodeTol.

1. Du meldest dich bei **<a href={console}>MrCodeTol Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst MrCodeTol Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner MrCodeTol-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opencode/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. MrCodeTol verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Laguna S 2.1 Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf MrCodeTol verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf MrCodeTol verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben MrCodeTol Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit MrCodeTol auch jeden anderen Provider zu verwenden.
