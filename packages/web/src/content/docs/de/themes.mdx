...
Mit MrCodeTol kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet MrCodeTol das `opencode`-Theme.
...
MrCodeTol liefert mehrere eingebaute Themes mit.
...
- MrCodeTol optisch ans Terminal anpassen wollen
...
MrCodeTol unterstuetzt ein flexibles JSON-basiertes Theme-System.
