---
title: Share
description: Share your MrCodeTol conversations.
---

MrCodeTol's share feature allows you to create public links to your MrCodeTol conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, MrCodeTol:
...
MrCodeTol supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, MrCodeTol uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
