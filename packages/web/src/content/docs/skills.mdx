...
Agent skills let MrCodeTol discover reusable instructions from your repo or home directory.
...
MrCodeTol searches these locations:
...
For project-local paths, MrCodeTol walks up from your current working directory until it reaches the git worktree.
...
MrCodeTol lists available skills in the `skill` tool description.
