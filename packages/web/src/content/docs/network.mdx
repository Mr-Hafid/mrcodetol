...
MrCodeTol supports standard proxy environment variables and custom certificates for enterprise network environments.

---

## Proxy

MrCodeTol respects standard proxy environment variables.
...
If your enterprise uses custom CAs for HTTPS connections, configure MrCodeTol to trust them.
