...
Du kan tilføje brugerdefinerede kommandoer gennem MrCodeTol-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din MrCodeTol [config](/docs/config):
