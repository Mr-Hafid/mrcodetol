---
title: Deling
description: Del dine MrCodeTol-samtaler.
---

MrCodeTols delingsfunksjon lar deg lage offentlige lenker til dine MrCodeTol-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, MrCodeTol:
...
MrCodeTol støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger MrCodeTol manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
