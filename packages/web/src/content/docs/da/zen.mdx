---
title: Zen
description: Udvalgt liste over modeller leveret af MrCodeTol.
---
...
MrCodeTol Zen er en liste over testede og verificerede modeller leveret af MrCodeTol-teamet.

Zen fungerer som enhver anden udbyder i MrCodeTol. Du logger ind på MrCodeTol Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med MrCodeTol.
:::
...
MrCodeTol Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

MrCodeTol Zen fungerer som enhver anden udbyder i MrCodeTol.

1. Du logger ind på **<a href={console}>MrCodeTol Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger MrCodeTol Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din MrCodeTol-konfiguration
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. MrCodeTol bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på MrCodeTol i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte MrCodeTol Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med MrCodeTol også.
