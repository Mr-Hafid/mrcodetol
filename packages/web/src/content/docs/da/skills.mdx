...
Agentferdigheter lar MrCodeTol oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
MrCodeTol søker etter disse stedene:
...
For prosjektlokale stier går MrCodeTol opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
MrCodeTol viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
