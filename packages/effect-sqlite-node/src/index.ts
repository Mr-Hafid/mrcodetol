...
export const TypeId: TypeId = "~@mrcodetol/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@mrcodetol/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@mrcodetol/effect-sqlite-node/NodeSqliteClient")
