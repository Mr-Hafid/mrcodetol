import type { JsonSchema, LLMRequest, ProviderMetadata } from "@mrcodetol/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@mrcodetol/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @mrcodetol/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
