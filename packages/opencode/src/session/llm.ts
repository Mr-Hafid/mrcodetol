...
import { llmClient } from "@mrcodetol/core/effect/app-node-platform"
...
import type { LLMEvent } from "@mrcodetol/llm"
import { LLMClient } from "@mrcodetol/llm/route"
import type { LLMClientService } from "@mrcodetol/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @mrcodetol/llm. It
