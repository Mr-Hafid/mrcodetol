...
import { Hash } from "@mrcodetol/core/util/hash"
...
import { optional } from "@mrcodetol/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@mrcodetol/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
