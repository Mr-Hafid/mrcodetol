export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do MrCodeTol",
  ...
  "desktop.menu.ariaLabel": "Menu do MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o MrCodeTol",
  "desktop.recovery.terminated": "A janela do MrCodeTol foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O MrCodeTol não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do MrCodeTol",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O MrCodeTol não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do MrCodeTol foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MrCodeTol.",
  ...
  "dialog.server.description": "Trocar para qual servidor MrCodeTol este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o MrCodeTol em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o MrCodeTol em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o MrCodeTol em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "O MrCodeTol está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O MrCodeTol está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o MrCodeTol em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MrCodeTol possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MrCodeTol não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MrCodeTol novamente.",
  ...
  "help.tabs.introduction": "Agora, o MrCodeTol Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do MrCodeTol ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MrCodeTol",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MrCodeTol ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MrCodeTol dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Personalize como o MrCodeTol aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MrCodeTol segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MrCodeTol é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MrCodeTol iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MrCodeTol.",
