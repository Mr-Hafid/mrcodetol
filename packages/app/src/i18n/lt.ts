...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "MrCodeTol įkelti nepavyko",
  "MrCodeTol langas netikėtai užsidarė",
  "MrCodeTol neatsako",
  ...
  "MrCodeTol įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "MrCodeTol neįdiegtas distributyve {{distro}}",
  "MrCodeTol naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami MrCodeTol modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius MrCodeTol.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio MrCodeTol serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama MrCodeTol {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas MrCodeTol {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite MrCodeTol {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite MrCodeTol į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad MrCodeTol galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują MrCodeTol ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą MrCodeTol komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad MrCodeTol dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "MrCodeTol darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite MrCodeTol serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite MrCodeTol ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip MrCodeTol atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar MrCodeTol seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite MrCodeTol temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas MrCodeTol",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią MrCodeTol versiją.",
