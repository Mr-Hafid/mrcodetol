export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in MrCodeTol.",
  ...
  "dialog.server.description": "Cambia il server MrCodeTol a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo MrCodeTol in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento MrCodeTol in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna MrCodeTol in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa MrCodeTol in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che MrCodeTol possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di MrCodeTol ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team MrCodeTol",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: MrCodeTol non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server MrCodeTol all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di MrCodeTol sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se MrCodeTol segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di MrCodeTol",
  ...
  "settings.updates.toast.latest.title": "MrCodeTol è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di MrCodeTol.",
  ...
  "desktop.menu.documentation": "Documentazione di MrCodeTol",
  ...
  "desktop.menu.ariaLabel": "Menu MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare MrCodeTol",
  "desktop.recovery.terminated": "La finestra di MrCodeTol si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "MrCodeTol non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di MrCodeTol non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di MrCodeTol è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
