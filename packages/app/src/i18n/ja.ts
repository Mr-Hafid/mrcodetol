export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTolを読み込めませんでした",
  "desktop.recovery.terminated": "MrCodeTolのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "MrCodeTolが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTolのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはMrCodeTolがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "MrCodeTolのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "MrCodeTolが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、MrCodeTolで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMrCodeTolで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、MrCodeTolで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するMrCodeTolサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "MrCodeTolを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のMrCodeTolを確認中...",
  "wsl.onboarding.updatingOpencode": "MrCodeTolを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のMrCodeTolを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のMrCodeTolを更新してください。",
  "wsl.onboarding.updateOpencode": "MrCodeTolを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のMrCodeTolの準備ができました。",
  "wsl.onboarding.opencodeReady": "MrCodeTolの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にMrCodeTolをインストールしてください。",
  "wsl.onboarding.installOpencode": "MrCodeTolをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTolがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MrCodeTolでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、MrCodeTolをもう一度開いてください。",
  ...
  "help.tabs.introduction": "MrCodeTol Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MrCodeTolの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMrCodeTolチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MrCodeTolはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTolには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMrCodeTolサーバーを実行します。",
  ...
  "settings.general.row.language.description": "MrCodeTolの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMrCodeTolの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "MrCodeTolがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "MrCodeTolのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "MrCodeTol の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "MrCodeTol は最新バージョンです。",
