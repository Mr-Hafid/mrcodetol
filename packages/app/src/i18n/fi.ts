export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "MrCodeToln tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MrCodeTolssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja MrCodeTolssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MrCodeTolssa.",
  ...
  "dialog.server.description": "Vaihda MrCodeTol-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan MrCodeTola...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan MrCodeTola kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään MrCodeTola...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään MrCodeTola kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä MrCodeTol jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna MrCodeTol jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTola ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin MrCodeTol voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten MrCodeTol uudelleen.",
  ...
  "toast.update.description": "MrCodeToln uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä MrCodeTol-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että MrCodeTol ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita MrCodeTol-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda MrCodeToln näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä MrCodeTol näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö MrCodeTol järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta MrCodeToln teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun MrCodeTol käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät MrCodeToln uusinta versiota.",
  ...
  "desktop.menu.documentation": "MrCodeTol-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "MrCodeTol-valikko",
  ...
  "desktop.recovery.loadFailed": "MrCodeToln lataaminen epäonnistui",
  "desktop.recovery.terminated": "MrCodeTol-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "MrCodeTol ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeToln asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTola ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MrCodeToln päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
