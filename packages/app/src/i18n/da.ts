export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i MrCodeTol.",
  ...
  "dialog.server.description": "Skift hvilken MrCodeTol-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker MrCodeTol i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer MrCodeTol i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater MrCodeTol i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MrCodeTol kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MrCodeTol igen.",
  ...
  "toast.update.description": "En ny version af MrCodeTol ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MrCodeTol-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MrCodeTol understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MrCodeTol-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MrCodeTol ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om MrCodeTol skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas MrCodeTols tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MrCodeTol starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MrCodeTol.",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol kunne ikke indlæses",
  "desktop.recovery.terminated": "MrCodeTol-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af MrCodeTol mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af MrCodeTol er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
