...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol failed to load",
  "desktop.recovery.terminated": "MrCodeTol window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MrCodeTol is not responding",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTol installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
