export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل MrCodeTol",
  "desktop.recovery.terminated": "توقفت نافذة MrCodeTol بشكل غير متوقع",
  "desktop.recovery.unresponsive": "MrCodeTol لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت MrCodeTol",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث MrCodeTol، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك MrCodeTol Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MrCodeTol.",
  ...
  "dialog.server.description": "تبديل خادم MrCodeTol الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من MrCodeTol في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث MrCodeTol في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث MrCodeTol في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت MrCodeTol في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MrCodeTol من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MrCodeTol التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MrCodeTol.",
  ...
  "help.tabs.introduction": "أصبح MrCodeTol Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من MrCodeTol ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MrCodeTol",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MrCodeTol لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MrCodeTol نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MrCodeTol داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MrCodeTol",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MrCodeTol على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MrCodeTol يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MrCodeTol",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MrCodeTol.",
