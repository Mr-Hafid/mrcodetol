...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "MrCodeTol se nije uspio učitati",
  "Prozor aplikacije MrCodeTol neočekivano je zatvoren",
  "MrCodeTol ne reagira",
  ...
  "Instalacija aplikacije MrCodeTol nije uspjela",
  ...
  "MrCodeTol nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije MrCodeTol je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u MrCodeTol.",
  ...
  "dialog.server.description": "Promijenite na koji se MrCodeTol poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera MrCodeTol u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MrCodeTol u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte MrCodeTol u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte MrCodeTol u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte MrCodeTol",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što MrCodeTol može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite MrCodeTol.",
  ...
  "help.tabs.introduction": "Radna površina MrCodeTol sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MrCodeTol ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku MrCodeTol timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, MrCodeTol još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "MrCodeTol Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite MrCodeTol poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako MrCodeTol izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li MrCodeTol slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je MrCodeTol tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se MrCodeTol pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju MrCodeTol.",
