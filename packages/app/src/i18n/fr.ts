export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'MrCodeTol",
  "desktop.recovery.terminated": "La fenêtre MrCodeTol s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "MrCodeTol ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'MrCodeTol",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'MrCodeTol est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MrCodeTol.",
  ...
  "dialog.server.description": "Changez le serveur MrCodeTol auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'MrCodeTol dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'MrCodeTol dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour MrCodeTol dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez MrCodeTol dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MrCodeTol puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'MrCodeTol ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MrCodeTol",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MrCodeTol ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MrCodeTol inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MrCodeTol dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MrCodeTol sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MrCodeTol suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MrCodeTol",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MrCodeTol.",
