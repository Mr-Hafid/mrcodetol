export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol kunde inte läsas in",
  "desktop.recovery.terminated": "MrCodeTol-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "MrCodeTol svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av MrCodeTol misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i MrCodeTol.",
  ...
  "dialog.server.description": "Växla vilken MrCodeTol-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar MrCodeTol i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar MrCodeTol i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera MrCodeTol i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera MrCodeTol i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan MrCodeTol kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan MrCodeTol igen.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av MrCodeTol ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till MrCodeTol-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, MrCodeTol stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör MrCodeTol-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Anpassa hur MrCodeTol ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om MrCodeTol följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa MrCodeTols tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när MrCodeTol startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av MrCodeTol.",
