export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "Không tải được MrCodeTol",
  "desktop.recovery.terminated": "Cửa sổ MrCodeTol đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "MrCodeTol không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được MrCodeTol",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật MrCodeTol nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do MrCodeTol cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong MrCodeTol.",
  ...
  "dialog.server.description": "Chuyển máy chủ MrCodeTol mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra MrCodeTol trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật MrCodeTol trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật MrCodeTol trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt MrCodeTol trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi MrCodeTol có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của MrCodeTol ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm MrCodeTol",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: MrCodeTol chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ MrCodeTol bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của MrCodeTol trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem MrCodeTol tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi MrCodeTol khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của MrCodeTol.",
