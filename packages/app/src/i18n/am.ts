export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol መጫን አልቻለም",
  "desktop.recovery.terminated": "MrCodeTol መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "MrCodeTol ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTolመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በMrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በMrCodeTol ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "MrCodeTol ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በMrCodeTol ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በMrCodeTol ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው MrCodeTol አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "MrCodeTolን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ MrCodeTol በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን MrCodeTol በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "MrCodeTol ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን MrCodeTol በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTolአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) MrCodeTol WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ MrCodeTol።",
  ...
  "help.tabs.introduction": "MrCodeTol ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የMrCodeTol ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለMrCodeTol ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ MrCodeTol እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "MrCodeTol ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የMrCodeTol አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለMrCodeTol",
  ...
  "settings.general.row.appearance.description": "MrCodeTolበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "MrCodeTol ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "MrCodeTol ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "MrCodeTol ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የMrCodeTol እትም እያሄዱ ነው።",
