...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MrCodeTol.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MrCodeTol.",
  ...
  "dialog.server.description": "Switch which MrCodeTol server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MrCodeTol in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MrCodeTol in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MrCodeTol in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MrCodeTol in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MrCodeTol can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MrCodeTol ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MrCodeTol team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MrCodeTol does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MrCodeTol server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MrCodeTol",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MrCodeTol looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MrCodeTol follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MrCodeTol is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MrCodeTol launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MrCodeTol.",
