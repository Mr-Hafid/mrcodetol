export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap MrCodeTol ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "MrCodeTol tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan MrCodeTol gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini MrCodeTol selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MrCodeTol.",
  ...
  "dialog.server.description": "Tukar pelayan MrCodeTol yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak MrCodeTol dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini MrCodeTol dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini MrCodeTol dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang MrCodeTol dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MrCodeTol boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu MrCodeTol ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan MrCodeTol",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, MrCodeTol belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan MrCodeTol dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa MrCodeTol pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada MrCodeTol mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila MrCodeTol dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini MrCodeTol.",
