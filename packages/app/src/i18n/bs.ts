export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za MrCodeTol",
  ...
  "desktop.menu.ariaLabel": "MrCodeTol meni",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor MrCodeTol-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "MrCodeTol ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija MrCodeTol-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje MrCodeTol-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MrCodeTol-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MrCodeTol-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MrCodeTol-u.",
  ...
  "dialog.server.description": "Promijeni na koji se MrCodeTol server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera MrCodeTol u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MrCodeTol u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj MrCodeTol u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj MrCodeTol u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MrCodeTol mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MrCodeTol-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MrCodeTol timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MrCodeTol još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MrCodeTol server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MrCodeTol-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MrCodeTol izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MrCodeTol prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MrCodeTol-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MrCodeTol pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MrCodeTol-a.",
