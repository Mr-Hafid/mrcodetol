...
export const dict = {
  ...
  "desktop.menu.documentation": "MrCodeTol-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "MrCodeTol-meny",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol kunne ikke lastes inn",
  "desktop.recovery.terminated": "MrCodeTol-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "MrCodeTol svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av MrCodeTol mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av MrCodeTol er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MrCodeTol.",
  ...
  "dialog.server.description": "Bytt hvilken MrCodeTol-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MrCodeTol ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MrCodeTol-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MrCodeTol ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MrCodeTol-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MrCodeTol",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MrCodeTol ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om MrCodeTol skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MrCodeTol starter",
  ...
  "settings.updates.toast.latest.title": "MrCodeTol er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MrCodeTol.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker MrCodeTol i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer MrCodeTol i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater MrCodeTol i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer MrCodeTol i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MrCodeTol kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MrCodeTol på nytt.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
