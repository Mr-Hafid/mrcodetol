export const dict = {
  ...
  "desktop.menu.documentation": "MrCodeTol Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "MrCodeTol μενού",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "MrCodeTol το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "MrCodeTol δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTol η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MrCodeTol.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή MrCodeTol συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος MrCodeTol σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση MrCodeTol σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση MrCodeTol σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του MrCodeTol στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο MrCodeTol να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του MrCodeTol ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα MrCodeTol",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το MrCodeTol δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "MrCodeTol Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή MrCodeTol μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του MrCodeTol στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το MrCodeTol ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του MrCodeTol",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του MrCodeTol.",
