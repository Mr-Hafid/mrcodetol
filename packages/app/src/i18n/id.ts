export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol gagal dimuat",
  "desktop.recovery.terminated": "Jendela MrCodeTol berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "MrCodeTol tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi MrCodeTol gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan MrCodeTol selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di MrCodeTol.",
  ...
  "dialog.server.description": "Ganti server MrCodeTol mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa MrCodeTol di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui MrCodeTol di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui MrCodeTol di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol siap.",
  "wsl.onboarding.installOpencodeIn": "Instal MrCodeTol di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MrCodeTol dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru MrCodeTol ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim MrCodeTol",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: MrCodeTol belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server MrCodeTol di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan MrCodeTol di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah MrCodeTol mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat MrCodeTol diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru MrCodeTol.",
