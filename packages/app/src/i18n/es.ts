export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de MrCodeTol",
  ...
  "desktop.menu.ariaLabel": "Menú de MrCodeTol",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar MrCodeTol",
  "desktop.recovery.terminated": "La ventana de MrCodeTol se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "MrCodeTol no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar MrCodeTol",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de MrCodeTol finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MrCodeTol.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MrCodeTol.",
  ...
  "dialog.server.description": "Cambiar el servidor de MrCodeTol al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando MrCodeTol...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando MrCodeTol en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando MrCodeTol...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando MrCodeTol en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza MrCodeTol en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala MrCodeTol en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MrCodeTol pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de MrCodeTol ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de MrCodeTol",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: MrCodeTol aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MrCodeTol dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MrCodeTol en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MrCodeTol sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MrCodeTol.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MrCodeTol",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MrCodeTol.",
