export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol laadimine ebaõnnestus",
  "desktop.recovery.terminated": "MrCodeTol aken suleti ootamatult",
  "desktop.recovery.unresponsive": "MrCodeTol ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTol installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid MrCodeTol'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises MrCodeTol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises MrCodeTol.",
  ...
  "dialog.server.description": "Lülitage, millise MrCodeTol serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "MrCodeTol kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "MrCodeTol kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MrCodeTol värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "MrCodeTol värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda MrCodeTol jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda MrCodeTol",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige MrCodeTol asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui MrCodeTol saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti MrCodeTol.",
  ...
  "help.tabs.introduction": "MrCodeTol Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse MrCodeTol ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast MrCodeTol meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, MrCodeTol ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "MrCodeTol Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage MrCodeTol server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke MrCodeTol kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas MrCodeTol teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas MrCodeTol järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas MrCodeTol on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui MrCodeTol käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse MrCodeTol uusimat versiooni.",
