export const dict = {
  ...
  "desktop.menu.documentation": "MrCodeTol-documentatie",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol kan niet worden geladen",
  "desktop.recovery.terminated": "Het MrCodeTol-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "MrCodeTol reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van MrCodeTol is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De MrCodeTol-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in MrCodeTol te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in MrCodeTol te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in MrCodeTol te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke MrCodeTol-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "MrCodeTol controleren...",
  "wsl.onboarding.checkingOpencodeIn": "MrCodeTol controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MrCodeTol bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "MrCodeTol bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk MrCodeTol bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MrCodeTol bijwerken",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MrCodeTol is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer MrCodeTol in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer MrCodeTol",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat MrCodeTol een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens MrCodeTol opnieuw.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van MrCodeTol ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het MrCodeTol-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: MrCodeTol ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de MrCodeTol-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor MrCodeTol",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe MrCodeTol eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of MrCodeTol het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van MrCodeTol aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer MrCodeTol wordt gestart",
  ...
  "settings.updates.toast.latest.title": "MrCodeTol is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van MrCodeTol.",
