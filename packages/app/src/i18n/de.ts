...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MrCodeTol",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MrCodeTol zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in MrCodeTol zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MrCodeTol zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den MrCodeTol-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "MrCodeTol",
  ...
  "wsl.onboarding.checkingOpencode": "MrCodeTol wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "MrCodeTol in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "MrCodeTol wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "MrCodeTol in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie MrCodeTol in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MrCodeTol aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "MrCodeTol ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "MrCodeTol ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie MrCodeTol in {{distro}}.",
  "wsl.onboarding.installOpencode": "MrCodeTol installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MrCodeTol einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MrCodeTol erneut.",
  ...
  "toast.update.description": "Eine neue Version von MrCodeTol ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MrCodeTol-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MrCodeTol unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "MrCodeTol mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "MrCodeTol Desktop",
  ...
  "settings.desktop.wsl.description": "MrCodeTol-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MrCodeTol ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MrCodeTol auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MrCodeTol dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MrCodeTol anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MrCodeTol automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "MrCodeTol ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von MrCodeTol wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "MrCodeTol konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das MrCodeTol-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "MrCodeTol reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTol-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das MrCodeTol-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
