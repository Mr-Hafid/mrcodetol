...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MrCodeTol yüklenemedi",
  "desktop.recovery.terminated": "MrCodeTol penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "MrCodeTol yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "MrCodeTol kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MrCodeTol, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "MrCodeTol güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MrCodeTol tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MrCodeTol'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "MrCodeTol Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MrCodeTol'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MrCodeTol'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MrCodeTol sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MrCodeTol kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MrCodeTol kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "MrCodeTol güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde MrCodeTol güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki MrCodeTol'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "MrCodeTol'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde MrCodeTol hazır.",
  "wsl.onboarding.opencodeReady": "MrCodeTol hazır.",
  "wsl.onboarding.installOpencodeIn": "MrCodeTol'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "MrCodeTol'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MrCodeTol kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MrCodeTol'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MrCodeTol bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MrCodeTol'u tekrar açın.",
  ...
  "help.tabs.introduction": "MrCodeTol Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MrCodeTol'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MrCodeTol ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: MrCodeTol henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MrCodeTol ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MrCodeTol Masaüstü",
  ...
  "settings.desktop.wsl.description": "MrCodeTol sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MrCodeTol'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MrCodeTol'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MrCodeTol'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MrCodeTol'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MrCodeTol başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MrCodeTol'un en son sürümünü kullanıyorsunuz.",
