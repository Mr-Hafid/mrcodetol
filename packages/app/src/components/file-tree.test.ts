...
beforeAll(async () => {
  ...
  mock.module("@mrcodetol/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mrcodetol/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mrcodetol/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mrcodetol/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
