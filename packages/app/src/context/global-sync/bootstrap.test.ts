...
import type { Config, OpencodeClient, Project } from "@mrcodetol/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@mrcodetol/client/promise"
import type { NormalizedProviderListResponse } from "@mrcodetol/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
