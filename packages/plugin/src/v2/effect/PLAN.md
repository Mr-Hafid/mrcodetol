...
- Effect plugins import `@mrcodetol/plugin/v2/effect`, not `@mrcodetol/core`.
- Public domain values use generated `@mrcodetol/sdk` types.
...
- Define `PluginHost` domain capabilities in `@mrcodetol/plugin/v2/effect`.
