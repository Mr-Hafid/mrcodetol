...
The Promise plugin API is the async/await equivalent of `@mrcodetol/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@mrcodetol/plugin/v2/promise"
