...
> current private `@mrcodetol/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@mrcodetol/ai`
...
import { LLM } from "@mrcodetol/ai"
import { OpenAI } from "@mrcodetol/ai/providers/openai"
...
```ts
import { Message } from "@mrcodetol/ai"
...
import { LLM, Tool } from "@mrcodetol/ai"
...
```ts
import { LLM } from "@mrcodetol/ai/promise"
import { OpenAI } from "@mrcodetol/ai/providers/openai"
...
```ts
import { LLMSchema } from "@mrcodetol/ai/schema"
...
```ts
import { Provider, Protocol } from "@mrcodetol/ai/provider"
...
@mrcodetol/ai/promise
  Promise/AsyncIterable LLM facade

@mrcodetol/ai/schema
  serializable domain schemas

@mrcodetol/ai/provider
  experimental Provider and Protocol authoring APIs

@mrcodetol/ai/providers/openai
@mrcodetol/ai/providers/anthropic
@mrcodetol/ai/providers/google
...
```
