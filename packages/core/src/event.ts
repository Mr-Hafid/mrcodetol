...
import type { Data, Definition, Payload } from "@mrcodetol/schema/event"
...
import { Durable } from "@mrcodetol/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@mrcodetol/schema/event").ID
export type { Data, Definition, Payload } from "@mrcodetol/schema/event"
