...
import { ModelV2 } from "@mrcodetol/core/model"
import { SessionV2 } from "@mrcodetol/core/session"
import { Agent } from "@mrcodetol/schema/agent"
import { Location } from "@mrcodetol/schema/location"
import { Model } from "@mrcodetol/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@mrcodetol/schema/prompt"
import { Provider } from "@mrcodetol/schema/provider"
import { Project } from "@mrcodetol/schema/project"
import { ProjectDirectories } from "@mrcodetol/schema/project-directories"
import { PermissionV1 } from "@mrcodetol/schema/permission-v1"
import { Session } from "@mrcodetol/schema/session"
import { SessionInput } from "@mrcodetol/schema/session-input"
import { SessionMessage } from "@mrcodetol/schema/session-message"
import { Workspace } from "@mrcodetol/schema/workspace"
import { Command } from "@mrcodetol/schema/command"
import { Connection } from "@mrcodetol/schema/connection"
import { Credential } from "@mrcodetol/schema/credential"
import { FileSystem } from "@mrcodetol/schema/filesystem"
import { Integration } from "@mrcodetol/schema/integration"
import { LLM } from "@mrcodetol/schema/llm"
import { Permission } from "@mrcodetol/schema/permission"
import { Plugin } from "@mrcodetol/schema/plugin"
import { Pty } from "@mrcodetol/schema/pty"
import { Reference } from "@mrcodetol/schema/reference"
import { SessionTodo } from "@mrcodetol/schema/session-todo"
import { Skill } from "@mrcodetol/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@mrcodetol/schema/schema"
import { ProviderV2 } from "@mrcodetol/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@mrcodetol/core/command"),
    import("@mrcodetol/core/integration/connection"),
    import("@mrcodetol/core/credential"),
    import("@mrcodetol/core/filesystem"),
    import("@mrcodetol/core/integration"),
    import("@mrcodetol/core/location"),
    import("@mrcodetol/llm"),
    import("@mrcodetol/core/permission"),
    import("@mrcodetol/core/v1/permission"),
    import("@mrcodetol/core/project/copy"),
    import("@mrcodetol/core/pty"),
    import("@mrcodetol/core/project/schema"),
    import("@mrcodetol/core/reference"),
    import("@mrcodetol/core/session/input"),
    import("@mrcodetol/core/session/message"),
    import("@mrcodetol/core/session/todo"),
    import("@mrcodetol/core/session/prompt"),
    import("@mrcodetol/core/skill"),
    import("@mrcodetol/core/v2-schema"),
    import("@mrcodetol/core/schema"),
    import("@mrcodetol/core/workspace"),
  ])
