import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@mrcodetol/sdk/v2"
import { SessionTurn } from "@mrcodetol/session-ui/session-turn"
import { SessionReview } from "@mrcodetol/session-ui/session-review"
import { DataProvider } from "@mrcodetol/session-ui/context"
import { FileComponentProvider } from "@mrcodetol/ui/context/file"
import { WorkerPoolProvider } from "@mrcodetol/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@mrcodetol/ui/logo"
import { IconButton } from "@mrcodetol/ui/icon-button"
import { ProviderIcon } from "@mrcodetol/ui/provider-icon"
import { iife } from "@mrcodetol/core/util/iife"
import { Binary } from "@mrcodetol/core/util/binary"
import { NamedError } from "@mrcodetol/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@mrcodetol/ui/tabs"
import { MessageNav } from "@mrcodetol/session-ui/message-nav"
import { FileSSR } from "@mrcodetol/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@mrcodetol/session-ui/pierre/worker").then((m) => ({
