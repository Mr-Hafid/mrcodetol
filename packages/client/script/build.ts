...
import { compile, emitEffectImported, emitPromise, write } from "@mrcodetol/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@mrcodetol/protocol/groups/event"',
            },
          },
        }),
