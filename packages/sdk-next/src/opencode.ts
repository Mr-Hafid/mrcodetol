import { OpenCode } from "@mrcodetol/client/effect"
...
import { createEmbeddedRoutes } from "@mrcodetol/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@mrcodetol/sdk-next/OpenCode") {}
