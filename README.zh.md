...
MrCodeTol 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
...
MrCodeTol 内置两种 Agent，可用 `Tab` 键快速切换：
...
如果你在项目名中使用了 “opencode”（如 “mrcodetol-dashboard” 或 “mrcodetol-mobile”），请在 README 里注明该项目不是 MrCodeTol 团队官方开发，且不存在隶属关系。
